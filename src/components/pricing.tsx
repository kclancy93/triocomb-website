        ...
        <section className="relative md:py-24 py-16 bg-slate-50 dark:bg-slate-800" id="pricing">
            <div className="container relative">
                ...
                <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 mt-6 gap-6">
                    <div className="group p-6 relative overflow-hidden shadow-sm dark:shadow-gray-700 bg-white dark:bg-slate-900 rounded-md h-fit">
                    ...
                    <div className="group relative overflow-hidden shadow-sm dark:shadow-gray-700 bg-white dark:bg-slate-900 rounded-md h-fit">
                        <div className="bg-teal-500 text-white py-2 px-6 h6 text-lg font-medium">Popular</div>
                        <div className="p-6">
                    ...
                    <div className="group relative overflow-hidden shadow-sm dark:shadow-gray-700 rounded-md border border-teal-500 h-fit">
